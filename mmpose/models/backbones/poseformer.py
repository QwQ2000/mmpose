...
class PoseFormer(BaseBackbone):
    def __init__(self, num_frame=9, num_joints=17, in_chans=2, embed_dim_ratio=32, depth=4,
                 ...
                 drop_rate=0., attn_drop_rate=0., drop_path_rate=0.2, act_cfg=dict(type='GELU'), 
        ...
        self.spatial_blocks = nn.ModuleList([
            TransformerEncoderLayer(embed_dims=embed_dim_ratio,
                                    num_heads=num_heads,
        ...
        self.blocks = nn.ModuleList([
            TransformerEncoderLayer(embed_dims=embed_dim,
                                    num_heads=num_heads,
                                    feedforward_channels=int(mlp_ratio* embed_dim),
                                    qkv_bias=qkv_bias,
                                    qk_scale=qk_scale,
